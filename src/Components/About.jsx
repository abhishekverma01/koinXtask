    ...
    <div className="bg-white h-max rounded-lg my-5 lg:p-6 p-2">
      <div>
        ...
        <div className=" mt-2 py-2">
          ...
          <div className="lg:flex gap-2 border-b-2 border-[#C9CFDD]/40 pb-4">
            <div className="mt-4">
              <div className="p-4 lg:w-[400px] h-[151px] bg-gradient-to-br from-[#79F1A4] to-[#0E5CAD] rounded-lg flex gap-2">
                <div className="w-32 h-32">
                  <img
                    className="w-full h-full rounded-xl object-cover"
                    src="https://rafalreyzer.com/wp-content/uploads/2023/02/A-Beginners-Guide-to-Sending-Swapping-Cryptocurrencies-featured-image.jpg"
                    alt=""
                  />
                </div>
                <div className="p-2 flex flex-col justify-center md:mr-10">
                  <div className=" text-white text-xl">
                    Calculate your Profits
                  </div>
                  <div className="bg-white px-3 py-2 rounded-lg mt-3 flex items-center w-[150px] flex-none">
                    Check Now
            ...
            <div className="mt-4 lg:ml-8">
              <div className="p-4 lg:w-[400px] h-[151px] bg-gradient-to-br from-[#FF9865] to-[#EF3031] rounded-lg flex gap-2">
                <div className="w-32 h-32">
                  <img
                    className="w-full h-full rounded-xl object-cover"
                    src="https://rafalreyzer.com/wp-content/uploads/2023/02/A-Beginners-Guide-to-Sending-Swapping-Cryptocurrencies-featured-image.jpg"
