...
function Crypto() {
  ...
  useEffect(() => {
    ...
    // Increase interval time to 30 seconds
  ...
  return (
    <div className="bg-white h-max rounded-lg my-5 p-2 sm:p-4 md:p-6">
      <div className="flex items-center">
        <div>
          <img src={img} className="w-7" alt="Bitcoin" />
        </div>
        <div className="text-xl font-semibold text-[#0B1426] pl-2">
          Bitcoin
        </div>
        <div className="text-sm text-[#5D667B] pl-2">BTC</div>
        <div className="bg-[#808A9D] p-1 sm:px-3 sm:py-2 text-white rounded-lg ml-7">
          Rank #1
        </div>
      </div>
      {error ? (
