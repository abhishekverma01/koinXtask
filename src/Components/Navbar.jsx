  ...
  return (
    <div className="lg:h-20 h-16 flex items-center justify-between shadow-[#1026490F]/10  shadow-md bg-[#FFFFFF]  w-screen">
      ...
      <div className="hidden lg:flex items-center ">
        <div className="text-lg font-semibold text-[#0F1629] mr-6 cursor-pointer">
          Crypto Taxes
        </div>
        <div className="text-lg font-semibold text-[#0F1629] mr-6 cursor-pointer">
          Free Tools{" "}
        ...
        <div>
          <button className="cursor-pointer outline-none font-medium bg-gradient-to-r from-[#2870EA] to-[#1B4AEF] px-8 py-2 text-white rounded-lg mx-14">
            Get Started
          </button>
        </div>
      </div>
