  ...
  return (
    <div className="bg-white h-max rounded-lg my-5 lg:p-6 p-3">
      <div>
        ...
        <div className="lg:flex overflow-x-hidden relative">
          <div className="md:w-[456px]  bg-[#E8F4FD] md:h-[204px] rounded-xl ">
          ...
          <div className="sm:hidden md:block absolute top-1/2 left-full transform -translate-y-1/2 -ml-8 bg-white p-4 rounded-full cursor-pointer">
              <FaAngleRight className="text-[#757779]" />
          </div>
          <div className="sm:hidden md:block absolute top-1/2 transform -translate-y-1/2 -ml-4 bg-white p-4 rounded-full cursor-pointer">
            <FaAngleLeft className="text-[#757779]" />
          </div>
          <div className="md:w-[456px] bg-[#EBF9F4] md:h-[204px] rounded-xl lg:ml-4 mt-4 lg:mt-0 ">
            <div className="p-4 flex">
              ...
              <div className="ml-2 w-[calc(100%-3rem)]">
                ...
                <div className="lg:text-sm text-sm font-normal text-[#3E5765] whitespace-normal mt-2 over">
                  Lorem ipsum dolor sit amet consectetur. Ac phasellus risus est
                  faucibus metus quis. Amet sapien quam viverra adipiscing
                  condimentum. Ac consectetur et pretium in a bibendum in. Sed
                  vitae sit nisi viverra natoque lacinia libero enim.
        ...
        <div className="mb-6">
          ...
          <div className="flex mt-2 items-center">
            <div className="text-2xl md:text-4xl bg-[#EBF9F4] text-[#0FBA83] w-[26%] md:w-[16%] aspect-square rounded-full items-center justify-center flex">
